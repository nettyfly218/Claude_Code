...
class ProgressPage {
            ...
            <div class="progress-page">
                ...
                <div class="word-mastery">
                    ...
                    <div class="mastery-chart-container">
                        ...
                        <div id="masteryPieChart" class="mastery-pie-chart"></div>
                    </div>
                </div>

                <!-- 学习趋势图 -->
                <div class="learning-trend">
                    <h3 class="trend-header">📈 本周学习趋势</h3>
    ...
    initCharts() {
        ...
        if (typeof Charts !== 'undefined') {
            Charts.createMasteryPie('masteryPieChart', masteryStats);

            // 创建周学习趋势图
            const weeklyData = Charts.getWeeklyTrendData(userProgress);
            Charts.createTrendChart('weeklyTrendChart', weeklyData, {
                height: 180,
